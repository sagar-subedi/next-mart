            ...
            <div className="w-2/4">
              <div>
                ...
                <input
                  ...
                  value="Events"
                  disabled
                  className="w-full border border-slate-200 outline-none bg-slate-100 text-slate-500 p-2 rounded-md cursor-not-allowed"
                />
              </div>
              <div className="mt-2">
                <label className="block font-semibold text-slate-800 mb-1">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      ...
                      {/* Ideally fetch subcategories for Events, or just show generic ones */}
