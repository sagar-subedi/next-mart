...
const EditEventPage = () => {
    ...
    const {
        ...
        defaultValues: {
            ...
            description: '',
            detailedDescription: '',
            warranty: 'No warranty', // Default for events usually
            slug: '',
            tags: '',
            brand: '',
            videoUrl: '',
    ...
    useEffect(() => {
        if (productData) {
            reset({
                ...
                category: 'Events', // Force category
                ...
                startDate: productData.startingDate ? new Date(productData.startingDate).toISOString().split('T')[0] : '',
                endDate: productData.endingDate ? new Date(productData.endingDate).toISOString().split('T')[0] : '',
            });
                            ...
                            <div className="w-2/4">
                                ...
                                <div className="flex gap-2 mb-4">
                                    <div className="w-[50%]">
                                        ...
                                        />
                                        {errors.startDate && (
                                            <p className="text-error">{String(errors.startDate.message)}</p>
                                        )}
                                    </div>
                                    <div className="w-[50%]">
                                        <Controller
                                        ...
                                        />
                                        {errors.endDate && (
                                            <p className="text-error">{String(errors.endDate.message)}</p>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="w-2/4">
                                <div className="mb-4">
                                    ...
                                    <input
                                        value="Events"
                                        disabled
                                        className="w-full border outline-none border-slate-300 bg-slate-100 p-2 rounded-md text-slate-500 cursor-not-allowed"
                                    />
                                </div>
